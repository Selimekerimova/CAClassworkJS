let arr = [2, 4, -3, 43, 41, -3, 0];

function findPostitivies(arr) {
  arr.filter((elem) => {
    elem > 0 ? elem : null;
    if (elem > 0) {
      console.log(elem);
...
// console.log(findPostitivies(arr))
...
// console.log(
//   webTechs.findIndex((element) => element === element.toLocaleUpperCase())
// );
...
// console.log(
//   webTechs2.filter((element) => element === element.toLocaleUpperCase())
// );
...
// console.log(
//   users.filter((item) => item.uni === "UNEC" && item.surname.startsWith("R"))
// );

// 2.2.Show users whose age is eqaul to 22 and name start 'a'.
// console.log(
//     users.filter((item)=>{
//         return item.age==='22' && item.name.startsWith('A')
//     })
// )
